...
<div class="container" style="position:absolute;left:15%;">
	...
	<input type="button"class="btn btn-primary  bg-info float-left"  style="margin:5px;" value="목록" onClick="location.href='normalbbs.jsp'">
			<input type="button"  class="btn btn-primary bg-info float-right"  style="margin:5px;" value="수정" onClick = "location.href='update_normal.jsp?bbsID=<%=bbsID %>'">
			<input type="button"  class="btn btn-primary bg-info float-right"  style="margin:5px;" value="삭제" onClick = "location.href='deleteAction.jsp?bbsID=<%=bbsID %>'">

	</div>
			<form method="post" action="comment_writeAction.jsp?bbsID=<%=bbsID %>">
...
function search(type,type2){
  location.href="comment_deleteAction.jsp?commentID="+type+"&bbsID="+type2;
}
</script>
